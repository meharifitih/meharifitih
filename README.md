...
* **Realtime Notifications Service (TypeScript/Node.js):** A WebSocket-based service for live order status and admin messages, using Redis Pub/Sub for horizontal scaling and JWT-authenticated connections.
